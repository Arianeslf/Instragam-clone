...
const msgContacts = [
  {
    id: 1,
    name: "coisas q Ari provavelmente curtiria",
    avatar: "/msg_ari1.jpg",
    avatar2: "/msg_ari2.jpg",
    preview: "Você enviou um anexo. · 21 h",
    unread: false,
  },
  {
    id: 2,
    name: "Dayani Lima",
    avatar: "/msg4.jpg",
    preview: "Você enviou um anexo. · 1 d",
    unread: false,
  },
  {
    id: 3,
    name: "Carla Stefani ★",
    avatar: "/msg6.jpg",
    preview: "Você enviou um anexo. · 2 sem",
    unread: false,
  },
  {
    id: 4,
    name: "Jonatas Muniz RB",
    avatar: "/msg8.jpg",
    preview: "Reagiu com 😆 à sua mensagem · 1 h",
    unread: true,
  },
  {
    id: 5,
    name: "Gustavo Thyerris",
    avatar: "/msg_gustavo.jpg",
    preview: "Enviou um anexo. · 2 h",
    unread: true,
  },
];
...
export default function MessageButton() {
  ...
  const openChat = (contact) => {
    ...
    setChats((prev) =>
      prev[contact.id] ? prev : { ...prev, [contact.id]: [] },
    );
  };
  ...
  return (
    <div className="message-btn-fixed">
          ...
          {activeChat ? (
            <>
              ...
              <div className="mc-header">
                ...
                <button
                  className="mc-icon-btn mc-close"
              ...
              <div className="mc-body">
                ...
                {messages.map((msg, i) => (
                  <div
                    key={i}
                    className={`mc-row ${msg.from === "me" ? "mc-row-me" : "mc-row-them"}`}
                  >
                    {msg.from !== "me" && (
                      <img
                    ...
                    <div
                      className={`mc-bubble ${msg.from === "me" ? "mc-bubble-me" : "mc-bubble-them"}`}
                    >
                      {msg.text}
                    </div>
                    {msg.from === "me" && (
              ...
              <div className="mc-input-bar">
                ...
                />
                {input.trim() ? (
                  <button className="mc-send-text" onClick={sendMessage}>
                    Enviar
                  </button>
                ) : (
                  <>
                    ...
                    <button className="mc-input-icon" title="Sticker">
                      <svg
                        ...
                        strokeWidth="1.8"
                      >
                        <path d="M12 2a10 10 0 0 1 10 10c0 2.5-.9 5.1-2.9 7.1L12 22H2V12C2 6.5 6.5 2 12 2z" />
            ...
            <>
              <div className="message-panel-header">
                Mensagens
                {BADGE > 0 && (
                  <span className="message-btn-badge">{BADGE}+</span>
                )}
                <div style={{ flex: 1 }} />
                <button
                  onClick={() => setOpen(false)}
                  ...
                  >
                    ...
                    >
                      {c.avatar2 ? (
                        ...
                        <img
                          className="message-panel-avatar"
                          src={c.avatar}
                          alt={c.name}
                        />
                      )}
                    ...
                    <div className="message-panel-info">
                      <div
                        className="message-panel-name"
                        style={{ fontWeight: c.unread ? 700 : 500 }}
                      >
                        {c.name}
                      </div>
                      <div
                        className="message-panel-preview"
                        style={{
                          fontWeight: c.unread ? 600 : 400,
                          color: c.unread ? "#fff" : "#a8a8a8",
                        }}
                      >
                        {chats[c.id]?.length
                          ? chats[c.id][chats[c.id].length - 1].text
                          : c.preview}
                      </div>
                    </div>
                  </div>
      ...
      <button className="message-btn" onClick={() => setOpen((o) => !o)}>
        <img
          src="/logo-instragao.svg"
          alt="msg"
          style={{ width: 20, height: 20, filter: "invert(1)", flexShrink: 0 }}
        />
